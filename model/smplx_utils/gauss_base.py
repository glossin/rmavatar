...
class GaussianBase(nn.Module):
    def __init__(self,args, sh_degree=0) -> None:
        super().__init__()
    ...
    # render
    def render_to_camera(self, viewpoint_cam,pose, pipe,iteration,total_iteration,deform_on, white_background='False',itr=-1, scaling_modifer=1.0):
        # if background == 'white':
        ...
        out = render(viewpoint_cam, self,pose, pipe,iteration,total_iteration,deform_on, background,itr, scaling_modifer)
