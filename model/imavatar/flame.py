...
class FLAME(nn.Module):
    ...
    def __init__(self, flame_model_path, lmk_embedding_path, n_shape, n_exp, shape_params, canonical_expression, canonical_pose):
        ...
        # with open("flame_model.obj", "w") as obj_file:
        #     for vertex in flame_model.v_template:
        #         obj_file.write("v {} {} {}\n".format(vertex[0], vertex[1], vertex[2]))
        #     if hasattr(flame_model, 'f'):
        #         for face in flame_model.f:
        #             obj_file.write("f")
        #             for vertex_index in face:
        #                 obj_file.write(" {}".format(vertex_index + 1))
        #             obj_file.write("\n")
    ...
    #     self.save_obj('yufeng.obj', self.v_template, self.faces)
    #
