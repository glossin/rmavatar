...
def make_frameset_data(dataset_config, split='train', frm_list=None):
    ...
    elif dataset_config.frameset_type == 'mhr_avatar':
        from .mhr_avatar_reader import MHRInstantAvatarDataset
        frameset = MHRInstantAvatarDataset(dataset_config, split=split, frm_list=frm_list)
    else:
